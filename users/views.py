...
def kakao_api(request):
    return redirect(
        'https://kauth.kakao.com/oauth/authorize?client_id=0e87f40293f38fb09d3d5a597dd6f4e3&redirect_uri=http://127.0.0.1:8000/oauth&response_type=code')
...
def kakao_api1(request):
    ...
    data = {"grant_type": 'authorization_code',
            'client_id': '0e87f40293f38fb09d3d5a597dd6f4e3',
